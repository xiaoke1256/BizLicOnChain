...
create table if not exists STOCK_HOLDER(
	...
	INVESTOR_NAME VARCHAR(64) NOT NULL COMMENT '股东姓名',
	...
	INVESTOR_CETF_HASH VARCHAR(128) NOT NULL COMMENT '股东身份证件,有效身份证件类型（身份证、居留证、军官证、中国护照、外国或地区护照）;和证件号码组成，由冒号(:)分隔。本字段需要加密',
